...
namespace InitialProject.Controller
{
    public class AccomodationController
    {
            ...
            do
            {
                ...
                switch (chosenOption)
                {
                    ...
                    case "10":
                        ...
                        RateAccomodation(acccId, ownerId, cleanliess, ownerFriendliess,commentText, goneTime);
        ...
        public void RateAccomodation(int accId, int ownerId, int cleanliness, int ownerFriendliness,string commentText, DateTime timeGone)
        {
            AccomodationRatingRepository accomodationRatingRepository = new AccomodationRatingRepository();

            DateTime now = DateTime.Now;

            accomodationRatingRepository.AddAccomodationRating(accId, ownerId,  cleanliness,  ownerFriendliness,  commentText,  timeGone);
            return;  
